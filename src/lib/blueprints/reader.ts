...
2. **즉시 확인 가능**: 사용자가 지금 당장 확인하고 답할 수 있는 현실적 질문
3. **inputTriggers 필수 설정**: 입력창이 필요한 모든 선택지에 설정
...
## 타입 설정 가이드
- **"multiple" (기본값)**: 이메일, 웹사이트, 슬랙, 메신저 앱, 도구 선택 등 **거의 모든 질문**
- **"single" (극히 제한적)**: 계정 보유 여부(Yes/No) 등 **이분법적 선택만**
