  ...
  "cards": [
    {
      "type": "flow",
      "title": "🚀 완벽한 실행 계획",
      "subtitle": "왕초보도 100% 성공하는 단계별 가이드", 
      "content": "Zapier로 완전 자동화 시스템을 5분만에 만드는 방법",
      "steps": [
        {
          "title": "1단계: Zapier 계정 생성하기",
          "description": "1. 크롬 브라우저를 열고 주소창에 https://zapier.com 을 입력한 후 엔터를 누르세요\\n2. 화면이 로딩되면 우상단의 파란색 'Sign Up' 버튼을 클릭하세요\\n3. 'Email' 입력란에 본인 이메일 주소를 정확히 입력하세요\\n4. 'Password' 입력란에 8자 이상의 비밀번호를 입력하세요\\n5. 하단의 'Get started free' 버튼을 클릭하세요\\n6. 이메일함을 확인하고 Zapier에서 온 인증 이메일의 'Verify Email' 버튼을 클릭하세요"
        },
        {
          "title": "2단계: 첫 번째 자동화 워크플로우 만들기", 
          "description": "1. 인증 완료 후 Zapier 대시보드에서 중앙의 큰 '+ Create Zap' 버튼을 클릭하세요\\n2. 'Choose Trigger App' 화면에서 'Google Sheets'를 검색창에 입력하고 클릭하세요\\n3. 트리거 옵션 중 'New Spreadsheet Row'를 선택하고 'Continue' 버튼을 클릭하세요\\n4. 'Connect Google Sheets' 화면에서 'Sign in to Google Sheets' 버튼을 클릭하세요\\n5. 구글 계정 선택 창에서 사용할 계정을 클릭하고 '허용' 버튼을 클릭하세요"
        },
        {
          "title": "3단계: 자동 알림 설정 완료하기",
          "description": "1. 이전 단계에서 설정한 Zapier 화면에서 '+ Next Step' 버튼을 클릭하세요\\n2. 'Choose Action App' 검색창에 'Slack'을 입력하고 클릭하세요\\n3. 액션 옵션 중 'Send Channel Message'를 선택하고 'Continue' 클릭하세요\\n4. 'Connect Slack' 화면에서 'Sign in to Slack' 버튼을 클릭하세요\\n5. 워크스페이스 선택 후 '허용' 버튼을 클릭하여 연동을 완료하세요\\n6. 화면 우상단의 'Publish' 버튼을 클릭하면 자동화가 활성화됩니다"
        }
      ],
      "engine": "Zapier (무료 플랜으로 충분)",
...
**핵심**: 스크린샷이 없어도 글만 보고 100% 따라할 수 있는 수준의 완벽한 설명!
