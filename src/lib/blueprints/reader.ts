...
### 📋 질문 타입 설정:
- **"single"**: 하나만 선택 가능 (계정 보유 여부, 사용 경험 등)
- **"multiple"**: 여러 개 선택 가능 (플랫폼 목록, 도구 목록, 기능 목록 등)

**플랫폼/도구 관련 질문은 반드시 "multiple" 타입으로 설정하세요!**
...
- type: "single" 또는 "multiple" (**플랫폼/도구 관련은 반드시 "multiple"**)
- options: 선택지 배열 (마지막에 "기타 (직접입력)", "잘모름 (AI가 추천)" 포함)
- inputTriggers: 입력창이 필요한 옵션들에 대한 설정

### 🎯 중요: 타입 설정 가이드
- **"multiple"**: 이메일, 웹사이트, 슬랙, 메신저 앱, 카카오톡 등 **여러 플랫폼 동시 선택 가능**
- **"single"**: 계정 보유 여부, 사용 경험 정도 등 **하나만 선택**
